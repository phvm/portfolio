<template>
  <div class="flex flex-col justify-center items-center md:items-baseline md:justify-evenly md:flex-row lg:px-20">
    <aside
    ...
    <main class="flex flex-col justify-center items-center md:w-3/5 xl:p-8 lg:items-end">
      <ExperienceCard
        ...
        :experience-title="experience.experienceTitle"
        :skills="experience.skills"
        :starting-date="experience.startingDate"
      />
    </main>
  </div>
</template>
